...
## 🛡️ Regras e Harness
Consulte estritamente o arquivo `docs/site-psicologa-andrielly/spec/RULES.md` para restrições técnicas e comportamentais inquebráveis.

## 📝 Comandos e Contexto Local
Psychology. Next.js 14, Framer Motion.
